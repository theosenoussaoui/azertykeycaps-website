...
- MUST: Use `max-w-6xl` (1152px) for all page containers
- MUST: Header and footer use same max-width as content
- MUST: 6-column visual grid lines align with container edges
- MUST: Content grids use 1/2/3/6 column patterns to align with visual grid

### Border Radius

- NEVER: Use `rounded-*` classes (brutalist aesthetic)
- All radius variables are set to `0`

### Colors

- MUST: Use oklch color space with hue 250
- MUST: Use design tokens (`bg-background`, `text-foreground`, etc.)
- NEVER: Hardcode colors like `bg-gray-100`

### Typography

- MUST: Use Space Mono font (inherits from body)
- MUST: Use container queries (`@sm:`, `@lg:`) not viewport queries (`sm:`, `lg:`)

### Components

- MUST: Use `render` prop for button/link composition
- MUST: Add `aria-label` to icon-only buttons
- MUST: Use semantic HTML (`article`, `nav`, `figure`, `time`, `dl`)

---

## Related Documentation

- [DESIGN_SYSTEM.md](../../docs/design/DESIGN_SYSTEM.md) - Full design system reference
- [COMPONENTS.md](../../docs/design/COMPONENTS.md) - Component patterns and variants
- [ANIMATION.md](../../docs/design/ANIMATION.md) - Animation guidelines
- [Z_INDEX.md](../../docs/design/Z_INDEX.md) - Z-index scale
- [WEB_ARCHITECTURE.md](../../docs/WEB_ARCHITECTURE.md) - Feature-based architecture
