export const fr = {
  ...
  articles: {
    ...
    suggestChange: "Suggérer une modification",
  },
  pages: {
    about: {
      title: "Informations",
    ...
    suggest: {
      ...
      form: {
        title: "Titre",
        titlePlaceholder: "Ex: GMK Dracula",
        url: "Lien du set",
        urlPlaceholder: "https://...",
        profile: "Profil",
        profilePlaceholder: "Sélectionner un profil",
        email: "Votre email",
        emailPlaceholder: "vous@exemple.com",
        emailDescription: "Pour vous contacter si nous avons des questions",
        description: "Description",
        descriptionPlaceholder: "Description optionnelle du set",
        material: "Matériau",
        materialPlaceholder: "Sélectionner un matériau",
        status: "Statut",
        statusPlaceholder: "Sélectionner un statut",
        startDate: "Date de début",
        startDatePlaceholder: "Sélectionner une date",
        endDate: "Date de fin",
        endDatePlaceholder: "Sélectionner une date",
        additionalUrl: "Lien additionnel",
        additionalUrlPlaceholder: "https://...",
        warningText: "Avertissement",
        warningTextPlaceholder: "Ex: Délai de livraison long",
        submit: "Envoyer la suggestion",
        submitting: "Envoi en cours...",
        editingBanner: "Vous suggérez une modification pour",
        newSubmission: "Nouvelle suggestion",
        successTitle: "Suggestion envoyée !",
        successDescription: "Merci ! Nous examinerons votre suggestion.",
        errorTitle: "Erreur",
        errorDescription:
          "Impossible d'envoyer la suggestion. Veuillez réessayer.",
        validation: {
